      ...
      <View style={{margin:20, top: 50}}>
            <View style={{alignItems:'center'}}>
                <TouchableOpacity onPress={toggleBottomNavigationView}>
                    <View className="py-3 bg-white rounded-xl border border-blue-800 " style={{height:100,width:100,borderRadius:15,justifyContent:'center',alignItems:'center',
                    borderColor: 'gray'}}>
                      {image && <Image source={{ uri: image }} style={{ width: 100, height: 100, borderRadius: 15 }} />}
                            ...
                            <View style={{
                                ...
                                <Icon name="camera" size={30} color="#d3d3d3" style={{opacity:0.7,alignItems:'center',justifyContent:'center',}}>
